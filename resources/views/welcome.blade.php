        ...
        <div class="max-w-7xl mx-auto flex items-center justify-between">
            ...
            @if (Route::has('login'))
                <div class="flex items-center gap-3">
                    @auth
                        <a href="{{ url('/dashboard') }}" class="inline-flex items-center gap-2 px-6 py-2.5 text-sm font-semibold text-white bg-linear-to-r from-blue-600 to-indigo-600 rounded-full shadow-lg shadow-blue-500/25 hover:shadow-xl hover:shadow-blue-500/30 hover:scale-105 transition-all duration-300">
                    ...
                    @else
                        <a href="{{ route('login') }}" class="inline-flex items-center gap-2 px-6 py-2.5 text-sm font-semibold text-white bg-linear-to-r from-blue-600 to-indigo-600 rounded-full shadow-lg shadow-blue-500/25 hover:shadow-xl hover:shadow-blue-500/30 hover:scale-105 transition-all duration-300">
                            <svg class="size-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                ...
                <div class="space-y-8 animate-fade-in-up">
                    ...
                    <div class="flex flex-wrap gap-4">
                        ...
                        @else
                            <a href="{{ route('login') }}" class="group inline-flex items-center gap-3 px-8 py-4 text-lg font-semibold text-white bg-linear-to-r from-blue-600 to-indigo-600 rounded-2xl shadow-xl shadow-blue-500/25 hover:shadow-2xl hover:shadow-blue-500/30 hover:scale-105 transition-all duration-300">
        ...
        <div class="relative overflow-hidden">
            ...
            <div class="relative max-w-7xl mx-auto px-6 lg:px-12 py-20">
                ...
                <div class="text-center mb-16">
                    ...
                    <h2 class="text-4xl lg:text-5xl font-bold text-white mb-4">{{ $schoolProfile?->name ?? config('app.name') }}</h2>
                    <p class="text-blue-200 text-lg max-w-2xl mx-auto">
                        NPSN: {{ $schoolProfile?->npsn ?? '-' }} • Terakreditasi {{ $schoolProfile?->accreditation ?? '-' }}
                    </p>
                </div>
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-blue-100 text-sm leading-relaxed">
                                        ...
                                        {{ $schoolProfile?->village }}, {{ $schoolProfile?->district }}<br>
                                        {{ $schoolProfile?->city }}, {{ $schoolProfile?->province }}<br>
                                        <span class="text-cyan-300 font-medium">Kode Pos: {{ $schoolProfile?->postal_code }}</span>
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-6 rounded-2xl bg-linear-to-br from-emerald-500/10 to-teal-500/5 backdrop-blur-sm border border-emerald-400/20 hover:border-emerald-400/40 transition-colors">
                            <div class="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <a href="tel:{{ $schoolProfile?->phone }}" class="text-emerald-300 hover:text-emerald-200 text-xl font-bold transition-colors">
                                        {{ $schoolProfile?->phone }}
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="p-6 rounded-2xl bg-linear-to-br from-purple-500/10 to-pink-500/5 backdrop-blur-sm border border-purple-400/20 hover:border-purple-400/40 transition-colors">
                            <div class="flex items-start gap-4">
                                ...
                                <div class="flex-1">
                                    ...
                                    <a href="mailto:{{ $schoolProfile?->email }}" class="text-purple-300 hover:text-purple-200 text-sm font-medium transition-colors break-all">
                                        {{ $schoolProfile?->email }}
                                    </a>
                                    <div class="mt-4 pt-4 border-t border-purple-400/20">
                                        ...
                                        <p class="text-purple-200 text-sm">{{ $schoolProfile?->operational_days }}</p>
                                        <p class="text-white font-bold text-lg">{{ $schoolProfile?->operational_hours }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="space-y-3">
                                ...
                                <a href="{{ $schoolProfile->whatsapp_1_url }}" target="_blank" class="flex items-center gap-4 p-4 bg-linear-to-r from-green-500/20 to-emerald-500/10 hover:from-green-500/30 hover:to-emerald-500/20 border border-green-400/30 hover:border-green-400/50 rounded-xl transition-all hover:scale-[1.02] group">
                                    <div class="w-12 h-12 rounded-full bg-linear-to-br from-green-400 to-emerald-500 flex items-center justify-center text-white font-bold text-lg shadow-lg shadow-green-500/30">
                                        {{ substr($schoolProfile->whatsapp_1_name, 4, 1) }}
                                    </div>
                                    <div class="flex-1 min-w-0">
                                        <p class="font-semibold text-white truncate">{{ $schoolProfile->whatsapp_1_name }}</p>
                                        <p class="text-green-300 text-sm font-mono">+{{ preg_replace('/(\d{2})(\d{3})(\d{4})(\d{4})/', '$1 $2-$3-$4', $schoolProfile->whatsapp_1) }}</p>
                                    </div>
                                ...
                                <a href="{{ $schoolProfile->whatsapp_2_url }}" target="_blank" class="flex items-center gap-4 p-4 bg-linear-to-r from-green-500/20 to-emerald-500/10 hover:from-green-500/30 hover:to-emerald-500/20 border border-green-400/30 hover:border-green-400/50 rounded-xl transition-all hover:scale-[1.02] group">
                                    <div class="w-12 h-12 rounded-full bg-linear-to-br from-emerald-400 to-teal-500 flex items-center justify-center text-white font-bold text-lg shadow-lg shadow-emerald-500/30">
                                        {{ substr($schoolProfile->whatsapp_2_name, 4, 1) }}
                                    </div>
                                    <div class="flex-1 min-w-0">
                                        <p class="font-semibold text-white truncate">{{ $schoolProfile->whatsapp_2_name }}</p>
                                        <p class="text-green-300 text-sm font-mono">+{{ preg_replace('/(\d{2})(\d{3})(\d{4})(\d{4})/', '$1 $2-$3-$4', $schoolProfile->whatsapp_2) }}</p>
                                    </div>
