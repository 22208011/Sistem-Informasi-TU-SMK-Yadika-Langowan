    ...
    <body class="min-h-screen bg-white antialiased dark:bg-linear-to-b dark:from-neutral-950 dark:to-neutral-900">
        <div class="relative grid h-dvh flex-col items-center justify-center px-8 sm:px-0 lg:max-w-none lg:grid-cols-2 lg:px-0">
            <div class="bg-muted relative hidden h-full flex-col p-10 text-white lg:flex dark:border-e dark:border-neutral-800">
                ...
                <a href="<?php echo e(route('home')); ?>" class="relative z-20 flex items-center gap-3 text-lg font-medium" wire:navigate>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($schoolProfile?->logo_url): ?>
                        <img src="<?php echo e($schoolProfile->logo_url); ?>" alt="<?php echo e($schoolProfile->name); ?>" class="h-10 w-auto" />
                    <?php else: ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::icon.academic-cap','data' => ['class' => 'size-6 text-white']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'size-6 text-white']); ?>
...
<?php /**PATH C:\laragon\www\tata-usaha-sekolah\resources\views\layouts\auth\split.blade.php ENDPATH**/ ?>