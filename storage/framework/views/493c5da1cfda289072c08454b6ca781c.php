...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::sidebar.brand','data' => ['name' => ''.e(config('app.name', 'Tata Usaha SMK')).'','attributes' => $attributes]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => ''.e(config('app.name', 'Tata Usaha SMK')).'','attributes' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($attributes)]); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::brand','data' => ['name' => ''.e(config('app.name', 'Tata Usaha SMK')).'','attributes' => $attributes]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php /**PATH D:\Hizkia Reppi\Developer\Fullstack Development\Sistem-Informasi-TU-SMK-Yadika-Langowan\resources\views/components/app-logo.blade.php ENDPATH**/ ?>