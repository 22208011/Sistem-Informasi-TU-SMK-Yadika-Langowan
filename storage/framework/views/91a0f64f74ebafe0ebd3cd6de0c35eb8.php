            ...
            <div class="w-full max-w-md">
                ...
                <div class="mt-6 text-center">
                    <p class="text-sm text-zinc-500 dark:text-zinc-400">
                        © <?php echo e(date('Y')); ?> <?php echo e($schoolProfile?->name ?? config('app.name')); ?>. All rights reserved.
                    </p>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\laragon\www\tata-usaha-sekolah\resources\views\layouts\auth\simple.blade.php ENDPATH**/ ?>