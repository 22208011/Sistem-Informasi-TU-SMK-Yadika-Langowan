...
<head>
    <meta charset="utf-8">
    <title><?php echo e($title ?? 'Laporan Resmi'); ?></title>
    <style>
        body {
...
<body>
    ...
    <table style="width: 100%; border-bottom: 3px solid #000; margin-bottom: 20px;">
        <tr>
            <td style="width: 15%; text-align: left; vertical-align: middle; border: none; padding-bottom: 10px;">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($logoYadika): ?>
                    <img src="<?php echo e($logoYadika); ?>" style="width: 90px; height: auto;">
            ...
            <td style="width: 15%; text-align: right; vertical-align: middle; border: none; padding-bottom: 10px;">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($logoTutwuri): ?>
                    <img src="<?php echo e($logoTutwuri); ?>" style="width: 90px; height: auto;">
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </td>
        </tr>
    </table>
    ...
    <div class="report-title">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($subtitle)): ?>
            <br><span style="font-size: 11pt; font-weight: normal;"><?php echo e($subtitle); ?></span>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </div>
    ...
    <div class="signature-block">
        <table class="signature-table">
            <tr>
                ...
                <td></td>
                <td>
                    Langowan, <?php echo e(now()->translatedFormat('d F Y')); ?><br>
                    <?php echo e($signerTitle ?? 'Kepala Sekolah'); ?>

                    <div class="signature-box">
                        <strong>( ......................................... )</strong><br>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($signerNip)): ?>
                            NIP: <?php echo e($signerNip); ?>
...
<?php /**PATH C:\laragon\www\tata-usaha-sekolah\resources\views\exports\layout.blade.php ENDPATH**/ ?>